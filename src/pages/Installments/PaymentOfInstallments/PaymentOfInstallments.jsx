...
function PaymentOfInstallments() {
  ...
  const data = {
    ...
    remainingMonths:
      installments?.installmentPeriod - installments?.countMonths,
  ...
  function payNowBtn() {
    ...
    const countMonths =
      customers[customerId].installments[installmentId].countMonths;
      ...
      if (parseFloat(data.amountPerMonth) == parseFloat(amountPerMonth)) {
        ...
        if (
          ...
          customers[customerId].installments[installmentId].installmentMonths[
            ...
            parseFloat(
              customers[customerId]?.installments[installmentId]
                ?.installmentMonths[countMonths + 1]?.amountPerMonth
            ) +
          ...
          if (
            parseFloat(
              customers[customerId]?.installments[installmentId]
                ?.installmentMonths[countMonths]?.amountPerMonth
            ) < parseFloat(data.amountPerMonth)
          ) {
            Swal.fire({
              position: "center",
        ...
        <form className="" onSubmit={handleSubmit(onSubmit)}>
          <div className="grid gap-5 w-[60%] ms-32 text-right">
            ...
            <div className="اختار القسط">
              ...
              {customerId != null && installmentId != null && (
                <div className="mt-8">
                  ...
                  <h4>
                    الشهر الحالي :
                    {installments?.installmentMonths[countMonths]
                      ?.amountPerMonth
                      ? installments?.installmentMonths[countMonths]
                          ?.amountPerMonth
                      : " القسط خلص"}
            ...
            <button
              ...
              className={`mb-20 mx-auto py-2 px-2 border ${
                watch("amountPerMonth") == "" && "border-gray-600 text-gray-600"
              } rounded-md`}
              type="submit"
              onClick={() => {
                setTimeout(() => {
